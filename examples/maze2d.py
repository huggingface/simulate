...
from .maze2denvs import LARGE_MAZE, LARGE_MAZE_EVAL, MEDIUM_MAZE, MEDIUM_MAZE_EVAL, U_MAZE, U_MAZE_EVAL, OPEN, parse_maze
...
scene += sm.Sphere(name='particle', position=[1.2,1.2,0], radius=0.1, material=sm.Material([0.0, 0.0, 1.0, 0.0]))
