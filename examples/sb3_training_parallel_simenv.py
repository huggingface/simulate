...
def create_env(executable=None, port=None, headless=None):
    ...
    root += sm.Box(name="floor", position=[0, -0.05, 0], scaling=[10, 0.1, 10], material=sm.Material.BLUE)
    root += sm.Box(name="wall1", position=[-1, 0.5, 0], scaling=[0.1, 1, 5.1], material=sm.Material.GRAY75)
    root += sm.Box(name="wall2", position=[1, 0.5, 0], scaling=[0.1, 1, 5.1], material=sm.Material.GRAY75)
    root += sm.Box(name="wall3", position=[0, 0.5, 4.5], scaling=[5.9, 1, 0.1], material=sm.Material.GRAY75)
    root += sm.Box(name="wall4", position=[-2, 0.5, 2.5], scaling=[1.9, 1, 0.1], material=sm.Material.GRAY75)
    root += sm.Box(name="wall5", position=[2, 0.5, 2.5], scaling=[1.9, 1, 0.1], material=sm.Material.GRAY75)
    root += sm.Box(name="wall6", position=[-3, 0.5, 3.5], scaling=[0.1, 1, 2.1], material=sm.Material.GRAY75)
    root += sm.Box(name="wall7", position=[3, 0.5, 3.5], scaling=[0.1, 1, 2.1], material=sm.Material.GRAY75)
    root += sm.Box(name="wall8", position=[0, 0.5, -2.5], scaling=[1.9, 1, 0.1], material=sm.Material.GRAY75)
